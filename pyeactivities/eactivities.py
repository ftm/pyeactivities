...
class CSP:
    ...
    def get_members(self, force_recheck=False, save_results=True) -> List["Member"]:
        """
    ...
    def get_committee_members(
        self, force_recheck=False, save_results=True
    ...
    def get_products(self, force_recheck=False, save_results=True) -> List["Product"]:
        """
